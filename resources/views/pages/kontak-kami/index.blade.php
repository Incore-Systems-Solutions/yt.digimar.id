...
<div class="post-area">
  ...
  <div class="row mb-2">
    <div class="col-md-12 text-center">
            <h2 class="fw-bold" style="color: #2c3e50;">Hubungi Kami untuk Kolaborasi Tim yang Lebih Produktif</h2>
      <p>Isi formulir di bawah ini untuk bertanya, berdiskusi, atau mendapatkan demo digimar.id. Kami siap membantu Anda meningkatkan kinerja dan transparansi kerja tim melalui platform kolaborasi yang efisien.</p>
    </div>
  </div>
